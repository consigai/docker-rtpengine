...
class EcrRepositoryStack(cdk.Stack):
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        repository = ecr.Repository(self,
                       "ConsigjambonzRtpengineRepo",
                       repository_name="consig-jambonz-rtpengine")

        jambonzRtpengine_image_asset = ecr_assets.DockerImageAsset(self, "jambonzRtpengine",
        ...
        ecrdeploy.ECRDeployment(self, f"DeployDockerImageSHA_{github_sha}",
                      src=ecrdeploy.DockerImageName(jambonzRtpengine_image_asset.image_uri),
...
# Create Docker Repo
#
EcrRepositoryStack(app, "jambonzRtpengine")
